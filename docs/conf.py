...
"""
edx-arch-experiments documentation build configuration file.
...
#
# html_title = 'edx-arch-experiments v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A plugin to include applications under development by the architecture team at edx ',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_arch_experiments'),
                os.path.join(root_path, 'edx_arch_experiments/migrations')])
